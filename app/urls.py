...
from problemSolving.problem.view import IssueProblemView, GetAssignedProblems, ConfirmProblem, GetAssignedMission
...
urlpatterns = [
    ...
    path('problem-solving/issue-problem/', IssueProblemView.as_view(), name='issue-problem'),
